  ...
  return (
    <div className="w-full h-full flex flex-col justify-center max-w-3xl mx-auto px-4 md:px-0">
      <div className="relative p-6 md:p-10 bg-white/60 backdrop-blur-md rounded-2xl border border-[#E6DFD5] shadow-2xl">
        ...
        {/* Scrapbook Doodles */}
        <svg className="absolute -bottom-8 -left-8 w-28 h-28 text-[#6F5E53]/40 pointer-events-none select-none scrapbook-float-slow-1" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.5" strokeDasharray="5 3">
          <circle cx="50" cy="50" r="40" />
          <circle cx="53" cy="52" r="38" opacity="0.5" strokeDasharray="3 5"/>
        </svg>
        <svg className="absolute top-6 right-8 w-12 h-12 text-[#E6B800]/85 pointer-events-none select-none transform rotate-12 scrapbook-float-slow-2" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2.5">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-[#1E1B18] mb-6 flex items-center gap-3">
          <span className="text-[#6F5E53]">01.</span> Who Am I?
        </h2>
        
        <p className="text-base md:text-lg text-[#4F4A45] leading-relaxed font-sans mb-4">
        ...
        <p className="text-base md:text-lg text-[#4F4A45] leading-relaxed font-sans">
