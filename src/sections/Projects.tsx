...
export default function Projects() {
  return (
    <div className="w-full h-full flex flex-col justify-center max-w-4xl mx-auto px-4 md:px-0 py-4 select-none relative">
      {/* Scrapbook Doodles */}
      <svg className="absolute top-2 right-12 w-14 h-14 text-[#6F5E53]/35 transform rotate-[25deg] pointer-events-none select-none" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="relative border-l-4 border-[#E6DFD5] pl-8 md:pl-10 ml-4 md:ml-6 space-y-14">
        {projectsList.map((project, idx) => (
          <div key={idx} className="relative group">
            {/* Timeline Circle */}
            <div className="absolute -left-10.5 md:-left-12.5 top-2 w-5 h-5 rounded-full bg-[#FAF6F0] border-3 border-[#6F5E53] group-hover:bg-[#E6B800] group-hover:border-[#1E1B18] transition-all duration-300"></div>
